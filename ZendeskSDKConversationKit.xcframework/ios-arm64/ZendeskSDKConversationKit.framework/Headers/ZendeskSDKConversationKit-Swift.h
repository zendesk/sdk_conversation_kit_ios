...
/// The url of the avatar to be displayed for the <code>Author</code>.
@property (nonatomic, copy) NSString * _Nullable avatarURL;
/// List of subroles associated with an author. Initially added to indicate if the message was generated by A.I.
/// Note: The use of [String] instead of [Subroles] is for compatibility with Objective-C.
@property (nonatomic, copy) NSArray<NSString *> * _Nullable subroles;
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id type:(enum ZDKAuthorType)type displayName:(NSString * _Nullable)displayName avatarURL:(NSString * _Nullable)avatarURL subroles:(NSArray<NSString *> * _Nullable)subroles OBJC_DESIGNATED_INITIALIZER;
/// Returns a Boolean value that indicates whether the receiver and a given object are equal.
/// \param object the object to compare against
///
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
...
/// Processes a <code>ProactiveMessage</code> status change.
/// \param status The current status of a <code>ProactiveMessage</code>.
///
/// \param proactiveMessage The current <code>ProactiveMessage</code>.
///
/// \param jwt <code>jwt</code> that represents the content of a <code>ProactiveMessage</code>.
///
- (void)proactiveMessageStatusChanged:(enum ZDKProactiveMessageStatus)status proactiveMessage:(ZDKProactiveMessage * _Nonnull)proactiveMessage jwt:(NSString * _Nullable)jwt;
/// Call to set the <code>VisitType</code> for the current visitor.
/// \param visitType The <code>VisitType</code> that can be <code>.new</code> or <code>.repeat</code>.
///
- (void)setVisitType:(enum ZDKVisitType)visitType;
/// Call to delete proactive messages data from storage
...
///
/// \param proactiveMessageId <code>id</code> of the Proactive Message.
///
/// \param completion Anonymous <code>User</code> for the app if successful, <code>Error</code> if not.
///
- (void)createAnonymousUserWith:(NSString * _Nullable)givenName surname:(NSString * _Nullable)surname proactiveMessageId:(NSString * _Nullable)proactiveMessageId completion:(void (^ _Nullable)(ZDKUser * _Nullable, NSError * _Nullable))completion;
...
/// Call to fetch the user’s list of conversations. This call will trigger a network request.
/// \param offset The number of items to skip before starting to collect the result set.
///
/// \param completion The list of <code>Conversation</code> if successful, <code>Error</code> if not.
///
- (void)getConversationsWithOffset:(NSInteger)offset completion:(void (^ _Nullable)(ZDKConversationList * _Nonnull, NSError * _Nullable))completion;
/// Call to fetch a list of messages before a given record <code>timestamp</code> for a given <code>conversation</code>. This call will trigger a network request.
/// \param timestamp The timestamp of the record before which a list of up to 100 messages wil be retrieved
///
/// \param conversationId The identifier of the <code>Conversation</code> containing the messages
///
/// \param completion The updated <code>Conversation</code> with the loaded messages if successful, <code>ConversationKitError</code> if not.
///
- (void)getMessagesBefore:(NSDate * _Nonnull)timestamp conversationId:(NSString * _Nonnull)conversationId completion:(void (^ _Nullable)(ZDKConversation * _Nullable, NSError * _Nullable))completion;
...
/// \param completion The <code>Conversation</code> if successful, <code>Error</code> if not.
///
- (void)createConversationWithProactiveMessageId:(NSString * _Nullable)proactiveMessageId completion:(void (^ _Nullable)(ZDKConversation * _Nullable, NSError * _Nullable))completion;
/// Call to get the <code>VisitType</code> for the current visitor.
/// \param completion The <code>VisitType</code> if successful, <code>Error</code> if not.
///
- (void)getVisitTypeWithCompletion:(void (^ _Nullable)(enum ZDKVisitType, NSError * _Nullable))completion;
/// Call to send a conversation referral. This call will fetch the updated conversation with the proactive message added.
/// \param proactiveMessageId The proactive message id tapped
///
...
SWIFT_CLASS_NAMED("ConversationList")
@interface ZDKConversationList : NSObject
/// A list of <code>Conversation</code>.
@property (nonatomic, readonly, copy) NSArray<ZDKConversation *> * _Nonnull conversations;
/// Whether there are more conversations available than the ones returned
@property (nonatomic, readonly) BOOL hasMore;
- (nonnull instancetype)initWithConversations:(NSArray<ZDKConversation *> * _Nonnull)conversations hasMore:(BOOL)hasMore OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// The <code>Conversation</code> is active
  ZDKConversationStatusActive = 0,
/// The <code>Conversation</code> is inactive
  ZDKConversationStatusIdle = 1,
/// The <code>Conversation</code> status is undefined
  ZDKConversationStatusUnknown = 2,
};
...
SWIFT_CLASS_NAMED("ProactiveMessage")
@interface ZDKProactiveMessage : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
...
@property (nonatomic, readonly) NSInteger campaignVersion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Status that compliments a <code>ProactiveMessageStatusChanged</code> event in <code>ConversationKitEvent</code>
typedef SWIFT_ENUM_NAMED(NSInteger, ZDKProactiveMessageStatus, "ProactiveMessageStatus", open) {
/// Invoked when a proactive message will be displayed as a local notification.
  ZDKProactiveMessageStatusNotificationWillDisplay = 0,
/// Invoked when a proactive message has been displayed as a local notification.
  ZDKProactiveMessageStatusNotificationHasBeenDisplayed = 1,
/// Invoked when a proactive message has been clicked on.
  ZDKProactiveMessageStatusNotificationHasBeenClicked = 2,
/// Invoked when the first reply has been sent in a conversation opened through a proactive message.
  ZDKProactiveMessageStatusConversationHasBeenRepliedTo = 3,
};
...
@interface ZDKUser (SWIFT_EXTENSION(ZendeskSDKConversationKit))
/// Computed variable to detect if the latest <code>User</code>’s <code>Conversation</code> is active
@property (nonatomic, readonly) BOOL isLatestConversationActive;
@end

/// Represents the possible visit types for the SDK.
typedef SWIFT_ENUM_NAMED(NSInteger, ZDKVisitType, "VisitType", open) {
/// The very first time the SDK is initialized.
  ZDKVisitTypeNew = 0,
/// The SDK has previously been initialized.
...
SWIFT_CLASS("_TtC25ZendeskSDKConversationKit16ZDKActivityEvent")
@interface ZDKActivityEvent : NSObject
/// The received/updated <code>Activity</code>.
@property (nonatomic, readonly, strong) ZDKActivity * _Nonnull activity;
...
/// A <code>ProactiveMessage</code> event has occurred
SWIFT_CLASS("_TtC25ZendeskSDKConversationKit32ZDKProactiveMessageStatusChanged")
@interface ZDKProactiveMessageStatusChanged : NSObject
/// The status of the <code>ProactiveMessage</code>.
@property (nonatomic, readonly) enum ZDKProactiveMessageStatus status;
/// The content of the <code>ProactiveMessage</code>.
@property (nonatomic, readonly, strong) ZDKProactiveMessage * _Nonnull proactiveMessage;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
