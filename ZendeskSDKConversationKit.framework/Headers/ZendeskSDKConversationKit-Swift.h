...
- (void)resume;
/// Call to remove the current <code>User</code> and associated information from <code>ConversationKit</code>.
- (void)logout;
...
@property (nonatomic, readonly, copy) NSArray<id <ZDKMessageAction>> * _Nullable actions;
...
@property (nonatomic, readonly, copy) NSArray<id <ZDKMessageAction>> * _Nonnull actions;
...
/// The result of the authentication call with possible <code>Error</code>.
